            ...
            <div className="bg-white rounded-xl shadow-md p-8 mb-12">
              ...
              <div className="space-y-6 text-slate-700 leading-relaxed">
                <p className="text-center">
                  <span className="font-semibold text-slate-800">La Société à Responsabilité Limitée | SARL:</span> est une <span className="font-semibold text-slate-800">personne morale</span> constituée d'<span className="font-semibold text-slate-800">au moins 2 associés</span>dans la limite de 50 associés (personnes physiques ou morales) .
                </p>
                ...
                <p className="text-center">
                  <span className="font-semibold text-slate-800">La société est gérée</span> par une ou plusieurs personnes (gérants) qui auront la capacité d’agir au nom de la société.
                </p>
                  ...
                  <div className="text-left">
                    <div className="flex items-start">
                      ...
                      <div className="text-sm text-slate-700 leading-relaxed">
                        <span className="font-semibold">Protection des associés.</span> En cas de faillite, la responsabilité des associés est limitée à leurs apports. Le patrimoine des associés est donc séparé du patrimoine de l'entité juridique dans le cas d'une SARL.
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                ...
                <div className="space-y-6">
                  ...
                  <div className="text-left">
                    <span className="font-bold text-slate-800">(2)</span>
                    <span className="ml-2 text-sm text-slate-700 leading-relaxed">
                    La SARL reste la forme juridique la plus populaire en Tunisie du fait de la protection du patrimoine des associés.
                    </span>
                  </div>
      ...
      case 'preparer':
        return (
          <>
            ...
            <div className="bg-white rounded-xl shadow-md p-8 mb-12">
              <h2 className="text-3xl font-bold text-slate-800 text-center mb-8">
                Création d'une SARL | Ce Qu'il Faut Préparer
              </h2>
              
              <p className="text-center text-slate-700 leading-relaxed mb-12">
               Une Société A Responsabilité Limitée (SARL) a une raison sociale, une adresse, un statut qui définit le cadre de la collaboration des associés. Le statut rempli servira à ouvrir un compte bancaire provisoire nécessaire pour la création de votre entreprise.
              </p>
...
‍
                ...
                <div className="bg-gray-50 rounded-xl p-6 text-center">
                  ...
                  <p className="text-sm text-slate-600 mb-6">
                    Une SARL doit mentionner une adresse: contrat de location, ou attestation de domiciliation, ou du titre de propriété (ou contrat d’achat)
                  </p>
                ...
                <div className="bg-gray-50 rounded-xl p-6 text-center">
                  ...
                  <p className="text-sm text-slate-600 mb-6">
                 Le statut d'une SARL doit contenir, notamment, la dénomination sociale, l'objet social, les associés & leurs parts sociales, et l'adresse du siège social.
                  </p>
    ...
    <div className="min-h-screen bg-gray-50 px-4 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          Tout savoir sur la Société A Responsabilité Limitée (SARL)
          </p>
...
export default SarlFormeJuridique;